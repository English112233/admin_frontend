...
<script>
    ...
    import ForeignBizTypeEnum from '../ForeignBizTypeEnum'
    import ForeignPayTypeEnum from '../../enum/ForeignPayTypeEnum'
    import ForeignUtil from '../ForeignUtil'
                ...
                fieldConfig: {
                    ...
                    payType: {
                        ...
                        value: function (entity) {
                            return self.$getObjVal(ForeignPayTypeEnum.map, entity.payType)
                        }
                    },
                    bizType: {
                        label: '业务类型',
                        value: function (entity) {
                            return self.$getObjVal(ForeignBizTypeEnum, entity.bizType)
                        }
                    },
                    remitMoney: {
                        label: '汇款金额',
                        value: function (entity) {
                            return self.$moneyFormat(entity.remitMoney) + ForeignUtil.orderCurrency(entity.payType, entity.fixMoneyType, entity.currency)
                        }
                    },
                    currency: {
                        label: '到账币种',
                        value: function (entity) {
                            return self.$getObjVal(CurrencyEnum, entity.currency)
                        }
                    },
                    sucFlag: {
                        label: '交易状态',
