<template>
    <div class="mt20 info-all-wrap">
        <el-form method="post" :action="$getReqUrl(action)" onsubmit="return false;" id="merchantForm" label-width="200px">
            ...
            <p v-if="merchantLevel==='first'" style="overflow: hidden">
                <el-col :span="24">
                    <span>受益人：持股比例等于或大于25%的自然人股东（非法人）。如果需要开展跨境汇款业务，必须提供受益人信息。</span>
                    <el-button @click="addOwners" style="float: right;margin-right:15px;">添加受益人</el-button>
                </el-col>
            </p>
...
<script>
    ...
    // import { BankAccountTypeEnum, CategoryDataJson } from 'cpc-frontend-base'
